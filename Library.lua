...
function Library:AddNotify(confignotify)
    ...
    local NotifyFunc = {}
	spawn(function()
        if not game.CoreGui:FindFirstChild("Zinnerbeo") then
			local Zinnerbeo = Instance.new("ScreenGui")
			Zinnerbeo.Name = "Zinnerbeo"
			Zinnerbeo.Parent = game.CoreGui
			Zinnerbeo.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		end
		if not game.CoreGui.Zinnerbeo:FindFirstChild("NotifyLayout") then
			local NotifyLayout = Instance.new("Frame")
            NotifyLayout.Name = "NotifyLayout"
            NotifyLayout.Parent = game.CoreGui.Zinnerbeo
			...
			local Count = 0
			game.CoreGui.Zinnerbeo.NotifyLayout.ChildRemoved:Connect(function()
				for r, v in next, game.CoreGui.Zinnerbeo.NotifyLayout:GetChildren() do
		...
		for i, v in game.CoreGui.Zinnerbeo.NotifyLayout:GetChildren() do
        ...
        NotifyFrame.Parent = game.CoreGui.Zinnerbeo.NotifyLayout
...
function Library:AddWindow()
    ...
    ZinnerBeos.Parent = game.CoreGui
